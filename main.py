...
ops_note = st.text_area("營運回報、事務宣達 (如：今日物料狀況、人力異動)", placeholder="請輸入營運狀況...")
complaint_note = st.text_area("客訴處理 (若無則填「無」)", placeholder="請詳細記錄客訴原因與處理結果...")
